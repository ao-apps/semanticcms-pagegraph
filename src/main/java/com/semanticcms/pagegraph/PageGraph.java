...
public class PageGraph implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		semanticCMS.addScript("d3js", "/webjars/d3js/" + Projects.getVersion("org.webjars", "d3js", Maven.properties.getProperty("d3js.version")) + "/d3.min.js");
		semanticCMS.addScript("dagre-d3", "/webjars/dagre-d3/" + Projects.getVersion("org.webjars.npm", "dagre-d3", Maven.properties.getProperty("dagre-d3.version")) + "/dist/dagre-d3.min.js");
