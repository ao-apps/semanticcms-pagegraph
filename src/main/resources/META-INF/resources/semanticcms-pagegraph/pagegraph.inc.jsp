...
Copyright (C) 2016, 2018, 2019, 2020, 2021, 2022, 2025, 2026  AO Industries, Inc.
...
<%!
  private static void addAllParents(
    ...
    if (visited.add(pageRef)) {
      ...
      if (!dag.containsKey(page)) {
        dag.put(page, new LinkedHashSet<Page>());
      }
      for (ParentRef parentRef : page.getParentRefs()) {
        ...
        if (parentPageRef.getBook() != null) {
          ...
          if (!siblings.add(page)) {
            throw new AssertionError("Duplicate sibling: " + pageRef);
          }
          addAllParents(
            servletContext,
            request,
